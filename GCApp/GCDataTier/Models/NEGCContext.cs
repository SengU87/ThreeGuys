...
namespace GCDataTier.Models
{
    public partial class NEGCContext : DbContext
    {
        ...
        public DbSet<NPOAddress> NPOAddresses { get; set; }
        public DbSet<NPOEmail> NPOEmails { get; set; }
        public DbSet<NPOPhone> NPOPhones { get; set; }
        ...
        public DbSet<VolunteerAddress> VolunteerAddresses { get; set; }
        public DbSet<VolunteerEmail> VolunteerEmails { get; set; }
        public DbSet<VolunteerPhone> VolunteerPhones { get; set; }

        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            modelBuilder.Configurations.Add(new NPOMap());
            modelBuilder.Configurations.Add(new NPOAddressMap());
            modelBuilder.Configurations.Add(new NPOEmailMap());
            modelBuilder.Configurations.Add(new NPOPhoneMap());
            ...
            modelBuilder.Configurations.Add(new VolunteerAddressMap());
            modelBuilder.Configurations.Add(new VolunteerEmailMap());
            modelBuilder.Configurations.Add(new VolunteerPhoneMap());
        }
    }
}
